...
SECRET_KEY = 'django-insecure-dj57z+_&#@pj6@%1e+_f9!&*j-f!&kda+sduov*@b9p0d$x2$p'
...
AUTH_USER_MODEL = "filme.Usuario" # filme = app -- Usuario = classe
...
# Page where the user is redirected after logging in
